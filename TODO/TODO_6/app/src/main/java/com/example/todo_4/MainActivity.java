...
public class MainActivity<Public> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            boolean isVisible = savedInstanceState.getBoolean("Reply");
            if (isVisible) {
                mReply.setVisibility(View.VISIBLE);
                mDisplayMessage.setVisibility(View.VISIBLE);
                mDisplayMessage.setText(savedInstanceState.getString("MessageReceived"));
            }
        }
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        if(mDisplayMessage.getVisibility() == View.VISIBLE) {
            outState.putBoolean("Reply",true);
            outState.putString("MessageReceived",mDisplayMessage.getText().toString());
        }
